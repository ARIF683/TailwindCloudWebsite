...
const Allinone = () => {
  return (
    <>
      <div className="w-full mt-32 pb-10 ">
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 px-5 pt-4 gap-3 items-center ">
          {Data.map((item) => (
            <>
              <div>
                ...
                <div className="pl-7  text-lg text-left  pt-2 pb-4 ">
                  {item.para}
                </div>
              </div>
              <div>
